...
// Slot coords are constrained so every bubble stays fully INSIDE the cluster
// box: content-visibility:auto applies paint containment, which hard-clips
// anything that pokes past the cluster bounds (the "cut off bubbles" bug).
// (+12px margin on top/bottom edges so the ±11px idle drift can't cross them)
const VB_PATTERNS = [
  [ { x: 27, y: 25, s: 150 }, { x: 75, y: 19, s: 106 }, { x: 77, y: 55, s: 132 }, { x: 23, y: 68, s: 118 }, { x: 52, y: 83, s: 92 } ],
  [ { x: 73, y: 25, s: 150 }, { x: 25, y: 19, s: 106 }, { x: 23, y: 55, s: 132 }, { x: 77, y: 68, s: 118 }, { x: 48, y: 83, s: 92 } ],
];
...
function venueBubbleHTML(v, slot, idx) {
  ...
  return `<div class="vb-pos${anim ? '' : ' vb-pos--still'}" style="left:${slot.x}%;top:${slot.y}%;${anim ? `--i:${idx}` : ''}">
    <div class="${anim ? `vb-drift vb-drift--${idx % 4}` : 'vb-still'}"${driftStyle}>
...
function officialBadge(profile) {
  ...
  return ' <span class="official-badge" title="Spotd Editor" aria-label="Spotd verified" role="img">' +
    '<svg viewBox="0 0 24 24" width="16" height="16" focusable="false" aria-hidden="true">' +
      '<path fill="#FF6B4A" fill-rule="evenodd" d="M22.25 12c0-1.43-.88-2.67-2.19-3.34.46-1.39.2-2.9-.81-3.91s-2.52-1.27-3.91-.81c-.66-1.31-1.91-2.19-3.34-2.19s-2.67.88-3.33 2.19c-1.4-.46-2.91-.2-3.92.81s-1.26 2.52-.8 3.91c-1.31.67-2.2 1.91-2.2 3.34s.89 2.67 2.2 3.34c-.46 1.39-.21 2.9.8 3.91s2.52 1.26 3.91.81c.67 1.31 1.91 2.19 3.34 2.19s2.68-.88 3.34-2.19c1.39.45 2.9.2 3.91-.81s1.27-2.52.81-3.91c1.31-.67 2.19-1.91 2.19-3.34zm-11.71 4.2L6.8 12.46l1.41-1.42 2.26 2.26 4.8-5.23 1.47 1.36-6.2 6.77z"/>' +
    '</svg>' +
    '</span>';
}
function shareSpotd() {
...
const NEWS_ARTICLES = [
  ...
  { city: 'san-diego', img: 'https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?w=800&q=80', tag: 'Neighborhood Guide', author: 'Priya', title: 'Best Happy Hours in North Park San Diego (2026)', excerpt: 'French bistro cocktails at The Smoking Goat, late-night pizza at Caffè Calabria, craft cider at Bivouac — every North Park deal, verified for 2026.', url: '/blog/best-happy-hours-north-park-san-diego.html', date: 'June 2, 2026', readTime: '8 min' },
  { city: 'san-diego', img: 'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=800&q=80', tag: 'City Guide', author: 'Diego', title: 'Best Taco Tuesday Deals in San Diego (2026)', excerpt: 'Half-off tacos at El Chingon, AYCE at American Junkie, $2 street tacos at La Puerta — every verified Taco Tuesday deal in SD, updated for 2026.', url: '/blog/best-taco-tuesday-san-diego.html', date: 'June 1, 2026', readTime: '7 min' },
  { city: 'san-diego', img: 'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=800&q=80', tag: 'Neighborhood Guide', author: 'Sofia', title: 'Best Happy Hours in Little Italy, San Diego (2026)', excerpt: '$1 oysters at Ironside, sake specials at Cloak & Petal, rooftop cocktails at GlassDoor — every Little Italy happy hour deal, verified for 2026.', url: '/blog/best-happy-hours-little-italy-san-diego.html', date: 'May 31, 2026', readTime: '8 min' },
  { city: 'orange-county', img: 'https://images.unsplash.com/photo-1470337458703-46ad1756a187?w=800&q=80', tag: 'City Guide', author: 'Jordan', title: 'Best Happy Hours in Orange County (2026)', excerpt: 'Waterfront pints in Newport Beach, rooftop cocktails in Laguna Beach, pier views in Huntington Beach — every verified OC happy hour worth your time.', url: '/blog/best-happy-hours-orange-county.html', date: 'May 29, 2026', readTime: '10 min' },
  { city: 'san-diego', img: 'https://images.unsplash.com/photo-1533174072545-7a4b6ad7a6c3?w=800&q=80', tag: 'Events',      author: 'Emma',  title: 'San Diego Weekend Events: April 3\u20135, 2026', excerpt: 'Drone art shows, North Park Festival of Beers, Easter brunch, four Friday night markets, live tributes at Belly Up, and 25+ things to do this Easter weekend.', url: '/blog/sd-weekend-events-april-3-5-2026.html', date: 'April 2, 2026', readTime: '10 min' },
  { city: 'san-diego', img: 'https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?w=800&q=80', tag: 'City Guide',  author: 'Tyler',  title: 'Best Happy Hours in Pacific Beach (2026)', excerpt: '$2.50 beers at Rocky\u2019s, rooftop sushi at Cannonball, $3.50 drafts at Duck Dive \u2014 every PB happy hour worth your time.', url: '/blog/best-happy-hours-pacific-beach.html', date: 'March 31, 2026', readTime: '9 min' },
  { city: 'san-diego', img: 'https://images.unsplash.com/photo-1626700051175-6818013e1d4f?w=800&q=80', tag: 'City Guide',  author: 'Nina',  title: 'The Best Burritos in San Diego, Ranked', excerpt: 'La Perla\u2019s viral Oaxacalifornia, Lolita\u2019s classic California burrito, and 7 more spots locals swear by.', url: '/blog/best-burritos-san-diego.html', date: 'March 31, 2026', readTime: '8 min' },
