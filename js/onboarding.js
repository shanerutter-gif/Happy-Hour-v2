...
const OB_CITY_CONFIG = {
  'san-diego': {
    name: 'San Diego', state: 'CA', tagline: '520+ spots live',
    neighborhoods: [
  ...
  'orange-county': {
    name: 'Orange County', state: 'CA', tagline: '330+ spots live',
    neighborhoods: [
  ...
  'los-angeles': {
    name: 'Los Angeles', state: 'CA', tagline: '390+ spots live',
    neighborhoods: [
      { name: 'Silver Lake',     deals: 14, popular: true  },
      { name: 'Arts District',   deals: 16, popular: false },
      { name: 'Koreatown',       deals: 16, popular: false },
      { name: 'Hollywood',       deals: 14, popular: false },
      { name: 'Los Feliz',       deals: 14, popular: false },
      { name: 'Downtown',        deals: 13, popular: false },
      { name: 'Santa Monica',    deals: 13, popular: false },
      { name: 'Highland Park',   deals: 13, popular: false },
      { name: 'West Hollywood',  deals: 13, popular: false },
      { name: 'Echo Park',       deals: 12, popular: false },
    ],
    featured: [
      { name: 'La Cuevita',        deal: '$5 cocktails + $3 beers',        hood: 'Highland Park',   time: 'HH 5–8pm' },
      { name: 'The Golden Gopher', deal: 'Daily happy hour deals',         hood: 'Downtown',        time: 'HH 3–8pm' },
      { name: 'The Gold Room',     deal: 'Beer + tequila combos',          hood: 'Echo Park',       time: 'HH 6–9pm' },
      { name: 'Tiki-Ti',           deal: 'Classic tiki cocktails',         hood: 'Los Feliz',       time: 'Open 4pm' },
      { name: 'Ercoles 1101',      deal: 'All-day happy hour',             hood: 'Manhattan Beach', time: 'HH 10am–6pm' },
      { name: 'Shellback Tavern',  deal: 'Beachside drink specials',       hood: 'Manhattan Beach', time: 'HH 3–7pm' },
      { name: 'Hermosillo',        deal: '30 wines by the glass',          hood: 'Highland Park',   time: 'Open 5pm' },
      { name: 'The Room Hollywood',deal: 'Late happy hour deals',          hood: 'Hollywood',       time: 'HH 5–9pm' },
    ],
    mapPins: [
      { primary: { hood: 'Silver Lake', deals: 14, top: '32%', left: '38%' },   secondary: { hood: 'Downtown', deals: 13, top: '18%', right: '22%' } },
      { primary: { hood: 'Koreatown', deals: 16, top: '25%', left: '30%' },     secondary: { hood: 'Santa Monica', deals: 13, top: '40%', right: '20%' } },
      { primary: { hood: 'Hollywood', deals: 14, top: '35%', left: '45%' },     secondary: { hood: 'Highland Park', deals: 13, top: '20%', right: '28%' } },
      { primary: { hood: 'Arts District', deals: 16, top: '28%', left: '35%' }, secondary: { hood: 'Echo Park', deals: 12, top: '42%', right: '18%' } },
    ],
  },
  'new-york': {
    name: 'New York', state: 'NY', tagline: '75+ spots live',
    neighborhoods: [
      { name: 'Williamsburg',    deals: 11, popular: true  },
      { name: 'East Village',    deals: 7,  popular: false },
      { name: 'Park Slope',      deals: 5,  popular: false },
      { name: 'West Village',    deals: 3,  popular: false },
      { name: 'Gramercy',        deals: 3,  popular: false },
      { name: 'SoHo',            deals: 3,  popular: false },
      { name: 'TriBeCa',         deals: 3,  popular: false },
      { name: 'Harlem',          deals: 3,  popular: false },
    ],
    featured: [
      { name: 'Long Island Bar',     deal: '$7 cocktails',            hood: 'Cobble Hill',     time: 'HH 5–7pm' },
      { name: 'Nobody Told Me',      deal: 'Daily happy hour',        hood: 'Upper West Side', time: 'HH 3–6pm' },
      { name: 'Rolf’s',         deal: '$5 German beer',          hood: 'Gramercy',        time: 'Open 4pm' },
      { name: 'Zombie Hut',          deal: '$6 tiki drinks',          hood: 'Carroll Gardens', time: 'HH 5–7pm' },
      { name: 'Other Half Brewing',  deal: '$6 draft beer',           hood: 'Carroll Gardens', time: 'Open 12pm' },
      { name: 'Sweet Afton',         deal: '$6 craft beer',           hood: 'Astoria',         time: 'HH 4–7pm' },
      { name: 'Bohemian Hall',       deal: '$4 Czech beer',           hood: 'Astoria',         time: 'Open 5pm' },
      { name: 'Bar Lunatico',        deal: 'Live music + happy hour', hood: 'Bed-Stuy',        time: 'HH 5–7pm' },
    ],
    mapPins: [
      { primary: { hood: 'Williamsburg', deals: 11, top: '32%', left: '38%' }, secondary: { hood: 'East Village', deals: 7, top: '18%', right: '22%' } },
      { primary: { hood: 'East Village', deals: 7, top: '25%', left: '30%' },  secondary: { hood: 'Park Slope', deals: 5, top: '40%', right: '20%' } },
      { primary: { hood: 'West Village', deals: 3, top: '35%', left: '45%' },  secondary: { hood: 'Gramercy', deals: 3, top: '20%', right: '28%' } },
      { primary: { hood: 'SoHo', deals: 3, top: '28%', left: '35%' },          secondary: { hood: 'Williamsburg', deals: 11, top: '42%', right: '18%' } },
    ],
  },
  'chicago': {
    name: 'Chicago', state: 'IL', tagline: '270+ spots live',
    neighborhoods: [
      { name: 'River North',   deals: 21, popular: true  },
      { name: 'Logan Square',  deals: 15, popular: false },
      { name: 'Wicker Park',   deals: 13, popular: false },
      { name: 'Gold Coast',    deals: 13, popular: false },
      { name: 'Streeterville', deals: 11, popular: false },
      { name: 'West Loop',     deals: 9,  popular: false },
      { name: 'Lincoln Park',  deals: 9,  popular: false },
      { name: 'Lakeview',      deals: 9,  popular: false },
      { name: 'Bucktown',      deals: 9,  popular: false },
      { name: 'Old Town',      deals: 8,  popular: false },
    ],
    featured: [
      { name: 'Inkwell',                 deal: '$12 classic cocktails + $5 bites', hood: 'River West',    time: 'HH til 6pm' },
      { name: 'Archie’s Tavern',    deal: '$2 Hamm’s cans',              hood: 'Humboldt Park', time: 'Weekdays' },
      { name: 'Clover Sports & Leisure', deal: '$5 wells + $6 drafts',             hood: 'River West',    time: 'HH 4–7pm' },
      { name: 'The Ravenswood Tavern',   deal: '$4 pints + $4 shots',              hood: 'Ravenswood',    time: 'HH 3–6pm' },
      { name: 'The Hi-Lo',               deal: '$8 beer + shot combo',             hood: 'Humboldt Park', time: 'Open 5pm' },
      { name: 'TRUCE',                   deal: 'Sunday happy hour',                hood: 'Bucktown',      time: 'HH 4pm–close' },
      { name: 'The Alderman',            deal: 'Seasonal craft cocktails',         hood: 'Pilsen',        time: 'Open 5pm' },
      { name: 'Twin Anchors',            deal: '15 drafts + rotating cocktails',   hood: 'Old Town',      time: 'Open 4pm' },
    ],
    mapPins: [
      { primary: { hood: 'River North', deals: 21, top: '32%', left: '38%' },  secondary: { hood: 'Wicker Park', deals: 13, top: '18%', right: '22%' } },
      { primary: { hood: 'Logan Square', deals: 15, top: '25%', left: '30%' }, secondary: { hood: 'Gold Coast', deals: 13, top: '40%', right: '20%' } },
      { primary: { hood: 'West Loop', deals: 9, top: '35%', left: '45%' },     secondary: { hood: 'Lincoln Park', deals: 9, top: '20%', right: '28%' } },
      { primary: { hood: 'Wicker Park', deals: 13, top: '28%', left: '35%' },  secondary: { hood: 'Lakeview', deals: 9, top: '42%', right: '18%' } },
    ],
  },
  'austin': {
    name: 'Austin', state: 'TX', tagline: '225+ spots live',
    neighborhoods: [
      { name: 'East Austin',        deals: 21, popular: true  },
      { name: 'South Lamar',        deals: 16, popular: false },
      { name: 'Downtown',           deals: 15, popular: false },
      { name: 'East 6th',           deals: 11, popular: false },
      { name: 'South Congress',     deals: 10, popular: false },
      { name: 'Rainey Street',      deals: 8,  popular: false },
      { name: 'North Loop',         deals: 9,  popular: false },
      { name: 'Warehouse District', deals: 9,  popular: false },
      { name: 'Clarksville',        deals: 9,  popular: false },
      { name: 'The Domain',         deals: 6,  popular: false },
    ],
    featured: [
      { name: 'ATX Cocina',            deal: '$7 margaritas',              hood: 'Downtown',         time: 'HH 3–6pm' },
      { name: 'Casino El Camino',      deal: '$3 Lone Star',               hood: '6th Street',       time: 'Open 4pm' },
      { name: 'Loro Austin',           deal: 'Happy hour eats + drinks',   hood: 'The Domain',       time: 'HH 2–6pm' },
      { name: 'Culinary Dropout',      deal: '$5 house wine',              hood: 'Domain Northside', time: 'HH 2–5pm' },
      { name: 'Radio Coffee & Beer',   deal: 'Daily beer specials',        hood: 'Bouldin Creek',    time: 'HH 4–7pm' },
      { name: 'Bouldin Creek Cafe',    deal: '$5 wells',                   hood: 'Bouldin Creek',    time: 'HH 4–7pm' },
      { name: 'B.D. Riley’s',     deal: 'Irish pub happy hour',       hood: 'Mueller',          time: 'HH 4–7pm' },
      { name: 'The Water Trough',      deal: 'Daily happy hour',           hood: 'The Domain',       time: 'HH 4–7pm' },
    ],
    mapPins: [
      { primary: { hood: 'East Austin', deals: 21, top: '32%', left: '38%' },   secondary: { hood: 'Downtown', deals: 15, top: '18%', right: '22%' } },
      { primary: { hood: 'South Lamar', deals: 16, top: '25%', left: '30%' },   secondary: { hood: 'Rainey Street', deals: 8, top: '40%', right: '20%' } },
      { primary: { hood: 'South Congress', deals: 10, top: '35%', left: '45%' },secondary: { hood: 'East 6th', deals: 11, top: '20%', right: '28%' } },
      { primary: { hood: 'Downtown', deals: 15, top: '28%', left: '35%' },      secondary: { hood: 'North Loop', deals: 9, top: '42%', right: '18%' } },
    ],
  },
  'miami': {
    name: 'Miami', state: 'FL', tagline: '100+ spots live',
    neighborhoods: [
      { name: 'South Beach',     deals: 9, popular: true  },
      { name: 'Wynwood',         deals: 8, popular: false },
      { name: 'Brickell',        deals: 7, popular: false },
      { name: 'Coral Gables',    deals: 7, popular: false },
      { name: 'Coconut Grove',   deals: 5, popular: false },
      { name: 'Little Havana',   deals: 5, popular: false },
      { name: 'Design District', deals: 4, popular: false },
      { name: 'Mid-Beach',       deals: 5, popular: false },
    ],
    featured: [
      { name: 'Mac’s Club Deuce',   deal: '2-for-1 drinks',                hood: 'South Beach',     time: 'Til 5pm' },
      { name: 'MC Kitchen',              deal: 'Aperitivo hour + small plates', hood: 'Design District', time: 'HH 4–7pm' },
      { name: 'Lost Weekend',            deal: 'Discounted beer + cocktails',   hood: 'South Beach',     time: 'HH 4–8pm' },
      { name: 'Glass & Vine',            deal: 'Cocktails in Peacock Park',     hood: 'Coconut Grove',   time: 'HH 3–7pm' },
      { name: 'Bar Bevy',                deal: '$8 beers + $12 cocktails',      hood: 'Design District', time: 'HH 4–7pm' },
      { name: 'Barra Vieja',             deal: '$8 margaritas',                 hood: 'Doral',           time: 'HH 3–7pm' },
      { name: 'The ScapeGoat',           deal: '$10 cocktails + late night HH', hood: 'South of Fifth',  time: 'HH 5–8pm' },
      { name: 'Norman’s Tavern',    deal: 'Beer + cocktail specials',      hood: 'North Beach',     time: 'HH 4–7pm' },
    ],
    mapPins: [
      { primary: { hood: 'South Beach', deals: 9, top: '32%', left: '38%' },  secondary: { hood: 'Wynwood', deals: 8, top: '18%', right: '22%' } },
      { primary: { hood: 'Brickell', deals: 7, top: '25%', left: '30%' },     secondary: { hood: 'Coral Gables', deals: 7, top: '40%', right: '20%' } },
      { primary: { hood: 'Wynwood', deals: 8, top: '35%', left: '45%' },      secondary: { hood: 'Coconut Grove', deals: 5, top: '20%', right: '28%' } },
      { primary: { hood: 'Little Havana', deals: 5, top: '28%', left: '35%' },secondary: { hood: 'Design District', deals: 4, top: '42%', right: '18%' } },
    ],
  },
};
